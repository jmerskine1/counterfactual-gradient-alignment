...
RESULTS_FILE = 'Projects/MNIST_FACE/experiment_results_expanded.json'
MANIFEST_FILE = 'Projects/MNIST_FACE/experiment_manifest.txt'
...
def run_pipeline():
    try:
        ...
        # "Loading and saving to :  MODEL_ENSEMBLE_..."
...
def main():
    ...
    print(f"Starting {len(all_experiments)} expanded experiments with 5 epochs...")
