...
# GS Experiment Configuration for SST-2
LOSS_FUNCTIONS = ['multiclass_split_gs_embedding']
ALPHAS = [0.3, 0.5]
TRAIN_SIZES = [10, 20, 50, 100]

CONFIG_PATH = 'Projects/SST-2/config.yaml'
RESULTS_FILE = 'Projects/SST-2/experiment_results_gs.json'
MANIFEST_FILE = 'Projects/SST-2/experiment_manifest_gs.txt'
...
def run_pipeline():
    try:
        process = subprocess.Popen(
            ['python3', 'Projects/SST-2/pipeline.py'],
...
def main():
    ...
    print(f"Starting {len(all_experiments)} SST-2 GS experiments...")
