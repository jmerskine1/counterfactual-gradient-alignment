...
Model Parameters
"""
loss_name = "direction" # "direction", 'cross_entropy_batch', 'cross_entropy_l2', 'direction', 'direction_interactive' & more - see loss functions
overwrite = True
learning_rate = 0.01
batch_size = 64
...
output_name = f'MODEL_ENSEMBLE_{model_name}__OPTIM_{optim_name}__LR_{learning_rate}__BATCHSIZE_{batch_size}__DATA_{data_name}_filtered_{filter_info}__LOSS_{loss_name}_alpha_1p0'
...
for epoch in tqdm(range(50)):
    ...
    train_metrics = generate_results_ensemble(training_data.X,training_data.Y,models,ensemble_params,name="Train")
