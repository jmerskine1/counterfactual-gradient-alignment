...
# Custom Libraries
from counterfactual_alignment.custom_models   import SimpleClassifier, MLP, CNN,  GSPaper, GSPaperNew, GSPaper2, GSPaper3, BagOfWordsClassifier, BagOfWordsClassifierSimple, BagOfWordsClassifierSingle
...
output_path = "/model_outputs/" + data_name + "/"
...
for epoch in tqdm(range(15)):
    ...
    for m in range(n_models):
        ...
        for batch in train_combined_data_loader:
            trained_state, train_metrics = train_one_epoch(trained_state, batch, model, loss_functions[loss_name],rng, config=config)
