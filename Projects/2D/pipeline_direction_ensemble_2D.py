...
train = genCustomDataset(custom_datasets[config['data_params']['dataset']],config['data_params']['size'],knowledge_functions[config['data_params']['knowledge_func']],
                                                            train=True, visualise=config['visualisation']['visualise'],seed=config['hyperparams']['seed'])
...
output_name = f'MODEL_ENSEMBLE_{model_name}__OPTIM_{optim_name}__LR_{learning_rate}__BATCHSIZE_{batch_size}__DATA_{data_name}__LOSS_{loss_name}_alpha_0p99'
