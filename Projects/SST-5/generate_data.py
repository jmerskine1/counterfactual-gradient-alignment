...
def compile_K(data,label, paired=False,cf=False,int_out=False, train=False):
...
cf_train={'original': compile_K(cf_X,train_label,paired=True ,train=True),
         'modified': compile_K(cf_X,train_label,paired=True,cf=True, train=True)
         }
...
pickle_data = {'train':cf_train,'test':cf_test,'dev':cf_dev, 'n_classes':5}
